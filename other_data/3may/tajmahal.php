...
?>
    ...
    <div class="container-flex">
        <div class="row">
            <div class="tourist">
                <div class="col-lg-4">
                    <img src="content/img/tourist/tajmahal_6.jpg">
                </div>
                <div class="col-lg-8">
                    <p class="paragraph">The Taj Mahal is located on the right bank of the Yamuna River in a vast
        ...
        <div class="row">
            <div class="tourist">
                ...
                <div class="col-lg-12">
                    ...
                    <p class="paragraph">The Taj Mahal is considered to be the greatest architectural
                    ...
                    <p class="paragraph">The uniqueness of Taj Mahal lies in some truly remarkable innovations
                    ...
                    <h3 style=" color: rgb(35, 33, 33); margin :10px; font-style: italic; font-weight: bolder;">
                        <b>Criterion (i):</b>
                    </h3>
                    <p class="paragraph">
