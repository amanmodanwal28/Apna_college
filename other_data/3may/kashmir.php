...
?>
    ...
    <div class="container-flex">
        <div class="row">
            <div class="tourist">
                <div class="col-lg-4">
                    <img src="content/img/tourist/kashmir_6.jfif">
                </div>
                <div class="col-lg-8">
                    <p class="paragraph">Jammu & Kashmir tourism has been described as a paradise so many times
    ...
    <div class="container-flex">
        <div class="row">
            <div class="tourist">
                <div class="col-lg-12">
                    <h3 style=" color: rgb(35, 33, 33); margin :10px; font-style: italic; font-weight: bolder;">Amar
                        Mahal Palace
                    </h3>
                    <p class="paragraph">
                    ...
                    <h3 style=" color: rgb(35, 33, 33); margin :10px; font-style: italic; font-weight: bolder;">Bahu
                        Fort</h3>
                    <p class="paragraph">
                        Bahu Fort
                    ...
                    <h3 style=" color: rgb(35, 33, 33); margin :10px; font-style: italic; font-weight: bolder;">Akhnoor
                        Fort</h3>
                    <p class="paragraph">
                        Akhnoor Fort
                    ...
                    <h3 style=" color: rgb(35, 33, 33); margin :10px; font-style: italic; font-weight: bolder;">Ambaran
                    </h3>
                    <p class="paragraph">
                        Ambaran
