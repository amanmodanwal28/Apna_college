    ...
    let isDown = false;
            ...
            function buildPlaylist() {
                ...
                playlist.forEach((track, index) => {
                    ...
                    songContainer.addEventListener('click', () => playAudio(index, currentFolder, waveformCanvas));
                });
            }
 ...
 if (!audioCtx) {
        ...
        visualize(waveformCanvas);
            ...
            function visualize(canvas) {
                ...
                function draw() {
                    ...
                    for (let i = 0; i < NUM_PILLARS; i++) {
                        ...
                        ctx.fillRect(i * (PILLAR_WIDTH + SPACING), HEIGHT - height, PILLAR_WIDTH, height);
                    }
                }
            ...
            folderSelect.addEventListener('click', function (event) {
                const selectedFolder = event.target.closest('.box').getAttribute('data-folder');
        ...
        event.target.closest('.box').classList.add('active');
